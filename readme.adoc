...
==== Changed
1. https://src.reticentadmin.com/aryan/hardened-chromium/src/branch/main/patches/hardened-chromium/set-browser-defaults.patch[set-browser-defaults.patch] to enable WebRTC
